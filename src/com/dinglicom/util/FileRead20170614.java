 ...
 *
 */
public class FileRead20170614 {

	private static Log log = LogFactory.getLog(FileRead20170614.class);
	...
	public List<String> ListFileNameFileter(final String fileType,
			RestatedRequest restatedRequest) {
	 ...
	 *            需要过滤的文件类型
	 */
	public FileRead20170614(String filePath) {
